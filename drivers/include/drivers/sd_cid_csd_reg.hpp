...
struct sd_csd_v1_t
{
    ...
    sd_csd_max_read_block_len_t  max_read_block_len;       // Max read data block length. 4 bits
    ...
    sd_csd_max_curr_vdd_min_t    max_read_curr_vdd_min;    // Max read current at the minimal power supply. 3 bits
    sd_csd_max_curr_vdd_max_t    max_read_curr_vdd_max;    // Max read current at the maximal power supply. 3 bits
    sd_csd_max_curr_vdd_min_t    max_write_curr_vdd_min;   // Max write current at the minimal power supply. 3 bits
    sd_csd_max_curr_vdd_max_t    max_write_curr_vdd_max;   // Max read current at the maximal power supply. 3 bits
    sd_csd_dev_size_mul_t        dev_size_mul;             // Device size multiplier. 3 bits
    ...
    sd_csd_r2w_factor_t          r2w_factor;               // Write speed factor. 3 bits
    sd_csd_max_write_block_len_t max_write_block_len;      // Max write data block length. 4 bits
...
struct sd_csd_mmc_t
{
    ...
    sd_csd_r2w_factor_t          r2w_factor;               // Read to write speed factor. 3 bits
    sd_csd_max_write_block_len_t max_write_block_len;      // Max write data block length. 4 bits
    bool                         partial_block_write_en;   // Partial blocks for write allowed
    bool                         file_format_grp;          // File format group
    bool                         copy_flag;                // Copy flag (OTP)
